...
// get artical old data 
$a_id = $_REQUEST['aid'];


$stma = $pdo->prepare("SELECT * FROM uploaded_articles WHERE a_id=?");
$stma->execute(array($a_id));
$old_article_data = $stma->fetchAll(PDO::FETCH_ASSOC);
foreach($old_article_data as $view_data){
	$old_type = $view_data['type'];
	$old_title = $view_data['tittle'];
	$old_year = $view_data['vy'];
	$old_volume = $view_data['volume'];
	$old_month1 = $view_data['nm'];
	$old_month2 = $view_data['nm2'];
	$old_nos1 = $view_data['nos1'];
	$old_nos2 = $view_data['nos2'];
	$old_authors = $view_data['authors'];
	$old_url = $view_data['url'];
}
											...
											if(isset($_POST['submit'])){
												...
												if($type == "alif"){
													...
													if($upload == true){
														...
														$alif = $pdo->prepare("UPDATE uploaded_articles SET 
														type=?, 
														tittle=?, 
														vy=?, 
														volume=?, 
								...
								<form action="#" method="POST" enctype="multipart/form-data">
									<div class="form-group">
										<select class="form-select custom-select" aria-label="Default select example" name="type" required>
											<option value="<?php echo $old_type; ?>" selected><?php echo $old_type; ?></option>
									...
									<div class="form-group">
										<input class="form-control" type="text" id="lname" name="title" placeholder="Article Title " required value="<?php echo $old_title; ?>">
									</div>
									<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<select class="form-select custom-select" aria-label="Default select example" name="vy" required>
														<option value="<?php echo $old_year; ?>" selected><?php echo $old_year; ?></option>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<select class="form-select custom-select" aria-label="Default select example" name="volume" required>
														<option value="<?php echo $old_volume; ?>" selected><?php echo $old_volume; ?></option>
										...
										<div class="col-md-3">
											<div class="form-group">
												...
												<select class="form-select custom-select" aria-label="Default select example" name="month1" required>
													<option value="<?php echo $old_month1; ?>" selected><?php echo $old_month1; ?></option>
										...
										<div class="col-md-3">
											<div class="form-group">
												...
												<select class="form-select custom-select" aria-label="Default select example" name="month2" required>
													<option value="<?php echo $old_month2; ?>" selected><?php echo $old_month2; ?></option>
													<option value="January">January</option>
													<option value="February">February</option>
													<option value="March">March</option>
													<option value="April">April</option>
										...
										<div class="col-md-3">
											<div class="form-group">
												...
												<select class="form-select custom-select" aria-label="Default select example" name="nos1" required>
													<option value="<?php echo$old_nos1; ?>" selected><?php echo$old_nos1; ?></option>
													<option value="1">1</option>
													<option value="2">2</option>
													<option value="3">3</option>
													<option value="4">4</option>
										...
										<div class="col-md-3">
											<div class="form-group">
												...
												<select class="form-select custom-select" aria-label="Default select example" name="nos2" required>
													<option value="<?php echo $old_nos2; ?>" selected><?php echo $old_nos2; ?></option>
													<option value="1">1</option>
													<option value="2">2</option>
													<option value="3">3</option>
													<option value="4">4</option>
									...
									<div class="form-group">
										<input class="form-control" type="text" id="lname" name="authors" placeholder="Authors name " required value="<?php echo $old_authors; ?>">
									</div>
									<div class="form-group">
										<!-- <input class="form-control" type="file" id="Upload" name="Upload" required> -->
				    						
										<div class="box">
											<input type="file" name="Upload" id="file-2" class="inputfile inputfile-2 d-none" data-multiple-caption="{count} files selected" multiple value="<?php echo $old_url; ?>" />
									    ...
									    <input  class="btn btn-outline-primary btn-lg btn-block" type="submit" name="submit" value="Update Article">
									</div>
                                		</form>
                                	</div>
