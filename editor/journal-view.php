...
if($user_email == 'thesciencejournal@asuu.org.ng'){
	$article_edit_permission = 'Journal of Science';
}
else if($user_email == 'thejournalofhumanities@asuu.org.ng'){
	$article_edit_permission = 'Journal of Humanities';
}
else if($user_email == 'thejournalofsocialsciences@asuu.org.ng'){
	$article_edit_permission = 'Journal Social Sciences';
}
							...
							<div class="col-12">
								<div class="list_wrapper">
									...
									<div class="pdf_section">
										...
										<div class="pdf_wrap">
											<a href="uploaded_articles/<?php echo $row['url']; ?>" download="<?php echo $row['url']; ?>" ><img src="img/pdf_icon.png">(Download)</a>
										
										</div>
										<?php if($article_edit_permission == $row['type']) :?>
										<div class="pdf_wrap">
											<a href="edit_article.php?aid=<?php echo $row['a_id']; ?>" ><img class="al_edit_icon" src="img/edit_icon.png">(Edit)</a>
										</div>
											<div class="pdf_wrap">
											<a href="delete_article.php?aid=<?php echo $row['a_id']; ?>" ><img class="al_edit_icon" src="img/delete.png">(Delete)</a>
										</div>
										<?php endif; ?>
									</div>
								</div>
									...
									<div class="modal-dialog modal-xl">
										<div class="modal-content">
											...
											<div class="modal-body">
												<iframe src="uploaded_articles/<?php echo $row['url']; ?>" style="width:100%; height:600px;" frameborder="0"></iframe>					</div>
