...
$user_email = $_SESSION['username'];
	...
	if($user_email == 'thesciencejournal@asuu.org.ng'){
		$stm= $pdo->prepare("SELECT * FROM manuscripts_docs WHERE category=?");
		...
		$stm= $pdo->prepare("SELECT * FROM manuscripts_docs");
		$stm->execute();
	}
...
?>
     ...
     <link href="css/teb_menu.css" rel="stylesheet"/>
<style>
	.site-footer {
		margin-top: 43px;
	}
		...
		<div class='al_sub'> 
			<a href="mns_tracking.php">Submission History <span class="pull-right badge"><?php echo $allCount; ?></span></a>
		</div>
			<div class="container">
					...
					<div class="col-lg-11">
						<div class="row justify-content-center">
							<div class="col-lg-3 col-md-6 bg_color_1 mb-lg-0 mb-4">
								<h4 class="browse_title">Browse by Subject</h4>
									...
									<ul class="list-group">
										...
										<li class="list-group-item">
											<a id="al_tab1" href="#">Journal of Humanities
												<span class="pull-right badge"><?php echo postCount("Journal of Humanities"); ?>
											...
											<?php 
												...
												$alif->execute(array("Journal of Humanities"));
												$dbresult = $alif->fetchAll(PDO::FETCH_ASSOC);
										...
										<li class="list-group-item">
											<a id="al_tab2" href="#">Journal of Social Sciences
										...
										<div class="col-md-4  ">
											...
											<a href="archives.php?type=3">	<img class="card-img-top mx-auto img-fluid" src="img/journal_science.png" alt="Card image"></a>
												<div class="card-body">
													 ...
													 <a href="journal_science_board.php">Editorial Board</a>
...
<script src="js/Al_script.js"></script>