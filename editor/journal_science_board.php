                    ...
                    <div class="information_main_area">
                         ...
                         <div class="info_item">
                              <div class="info-single_item">
                                   ...
                                   <ul>
                                    ...
                                    <ul>
                                        <li><b>Dr. Simon Yange:</b></li>
                                        <li>
                                             <b>Editorial Assistant </b> <br>
                                              Federal University of Agriculture, <br>
                                             Makurdi, Nigeria <br>
                                             E-mail : <a href="mailto://styange@uam.edu.ng">styange@uam.edu.ng</a></a> <br>
                                            Phone: <a href="callto://+234 8064067803">+234 8064067803</a>
                                        </li>
                                   </ul>
                              </div>
                         ...
                         <div class="info_item">
                              <div class="info-single_item">
                                   ...
                                   <ul>
                                        <li><b>Prof. Tunde Ochende-Bello :</b></li>
                                        <li>
                                             University of Cape Town, Cape Town <br>
                                             State, Nigeria.
                                        </li>
                                   </ul>
                                   <ul>
                                        <li><b>Prof. U.A. Ali :</b></li>
                                        <li>
                                             Federal University, Dutse, Jigawa <br>
                                             State, Nigeria.
                                        </li>
                                   </ul>
                                   <ul>
                                        <li><b>Prof. E. Okunade :</b></li>
                                        <li>
                                             Obafemi Awolowo University, lle-lfe, <br>
                                             Nigeria.
                                        </li>
                                   </ul>
                                   <ul>
