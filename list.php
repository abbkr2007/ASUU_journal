								...
								<div class="list_wrapper">
									...
									<div class="listed_tags">
										...
										<select _ngcontent-nqw-c11="" class="custom-select" aria-label="content type dropdown" id="urlSelect" onchange="window.location = jQuery('#urlSelect option:selected').val();"><!---->
													<option _ngcontent-nqw-c11=""  value="all.php">All</option>
													<option _ngcontent-nqw-c11=""  value="archives.php">Current Issues</option>
													<option _ngcontent-nqw-c11=""  value="current_issue.php">Archives</option>
